    ...
    for i in range(level_count):
        if (
            ...
            return (
                ...
                notes[i],
                score_array[0],
                [min_range_array[1 - gender][0], max_range_array[1 - gender][0]],
                angle,
                measurement_name,
    ...
    for i in range(level_count):
        if (
            ...
            return (
                ...
                [min_range_array[1 - gender][0], max_range_array[1 - gender][0]],
                value,
                measurement_name,"N/A" if i == 0 else advice,
            )
    return (
        score_array[-1],
        notes[-1],
...
def side_input(
    ...
    (
        ...
        measurement_name,
        advice,
    ) = gonial_angle_score(gonialAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = nasofrontal_angle_score(nasofrontalAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = mandibular_plane_angle_score(mandibularPlaneAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = ramus_mandible_ratio_score(ramus2MandibleRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = facial_convexity_glabella_score(facialConvexityGlabella, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = submental_cervical_angle_score(submentalCervicalAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = nasofacial_angle_score(nasofacialAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = nasolabial_angle_score(nasolabialAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = orbital_vector_score(orbitalVector, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = total_facial_convexity_score(totalFacialConvexity, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = mentolabial_angle_score(mentolabialAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = facial_convexity_nasion_score(facialConvexityNasion, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = nasal_projection_score(nasalProjection, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = nasal_wh_ratio_score(nasalW2HRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = ricketts_E_line_score(rickettsELine, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = holdaway_H_line_score(holdawayHLine, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = steiner_S_line_score(steinerSLine, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = burstone_line_score(burstoneLine, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = nasomental_angle_score(nasomentalAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = gonion_mouth_relationship_score(gonion2MouthRelationship, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = browridge_inclination_angle_score(browridgeInclinationAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = nasal_tip_angle_score(nasalTipAngle, gender)
...
def front_input(
    ...
    (
        ...
        measurement_name,
        advice,
    ) = eye_separation_ratio_score(eyeSeparationRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = facial_thirds_score(facialThirds, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = lateral_canthal_tilt_score(lateralCanthalTilt, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = facial_wh_ratio_score(facialWHRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = jaw_frontal_angle_score(jawFrontalAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = cheekbone_high_setedness_score(cheekBoneHeight, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = total_facial_wh_ratio_score(totalFacialWHRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = bigonial_width_score(bigonialWidth, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = chin_philtrum_ratio_score(chin2PhiltrumRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = neck_width_score(neckWidth, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = mouth_nose_width_ratio(mouthWidth2NoseWidthRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = midface_ratio(midFaceRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = eyebrow_position_ratio_score(eyebrowPositionRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = eye_spacing_ratio_score(eyeSpacingRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = eye_aspect_ratio_score(eyeAspectRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = lower_upper_lip_ratio_score(lowerLip2UpperLipRatio, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = deviation_IAA_score(deviationOfJFA2IAA, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = eyebrow_tilt_score(eyebrowTilt, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = bitemporal_width_score(bitemporalWidth, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = lower_third_proporation_score(lowerThirdProporation, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = lpsilateral_alar_angle_score(ipsilateralAlarAngle, gender)
    ...
    (
        ...
        measurement_name,
        advice,
    ) = medial_canthal_angle(medialCanthalAngle, gender)
