...
for image_index in range(13, 49 + 1):
    if image_index == 22 or image_index == 25 or image_index == 36 or image_index == 41:
        continue

    image = cv2.imread("./src/2 (" + str(image_index) + ").jpg")
    kernel_size = (5, 5)
    ...
    cv2.imwrite(str(image_index) + ".jpg", image)
    print(result_points)
